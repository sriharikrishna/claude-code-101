...
- **Companion docs** referenced by the deck: `WORKFLOW.md`, `LITERATURE.md`, and `docs/native-claude-code-mapping.md` (how the workshop's four-file architecture maps to Claude Code's built-ins).
